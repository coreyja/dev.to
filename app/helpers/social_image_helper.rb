module SocialImageHelper
  ...
  def article_social_image_url(article)
    ...
    if image.present?
      return cl_image_path(image, type: "fetch", width: "1000", height: "500", crop: "imagga_scale", quality: "auto", flags: "progressive", fetch_format: "auto", sign_url: true)
    end
  ...
  def legacy_article_social_image(article)
    ...
    Rails.cache.fetch(cache_key, expires_in: 1.hour) do
      ...
      cl_image_path(src, type: "fetch", width: "1000", height: "500", crop: "imagga_scale", quality: "auto", flags: "progressive", fetch_format: "auto", sign_url: true)
    end
  end
