  ...
  module V0
    class ReactionsController < ApplicationController
      ...
      def create
        ...
        @reaction = Reaction.create(user_id: @user.id, reactable_id: params[:reactable_id], reactable_type: params[:reactable_type], category: params[:category] || "like")
      ...
      def onboarding
        ...
        reactable_ids.each do |article_id|
          Reaction.delay.create(user_id: current_user.id, reactable_id: article_id, reactable_type: "Article", category: "readinglist")
        end
      end
