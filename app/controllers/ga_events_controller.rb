class GaEventsController < ApplicationController
  ...
  def create
    ...
    tracker.pageview(path: json["path"], user_id: user_id, user_language: json["user_language"], referrer: (json["referrer"] if json["referrer"] && !json["referrer"].start_with?("https://dev.to")), user_agent: json["user_agent"], viewport_size: json["viewport_size"], screen_resolution: json["screen_resolution"], document_title: json["document_title"], document_encoding: json["document_encoding"], document_path: json["document_path"], cache_buster: rand(100_000_000_000).to_s, data_source: "web")
