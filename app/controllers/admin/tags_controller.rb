  ...
  class TagsController < Admin::ApplicationController
    def update
      ...
      if @tag.update(tag_params) && @tag.errors.messages.blank?
        ...
        render(:new, locals: {
          page: Administrate::Page::Form.new(dashboard, @tag),
        })
      end
    end
    ...
    def tag_params
      accessible = %i[name supported alias_for wiki_body_markdown rules_markdown short_summary requires_approval submission_template submission_rules_headsup pretty_name bg_color_hex text_color_hex keywords_for_search buffer_profile_id_code]
