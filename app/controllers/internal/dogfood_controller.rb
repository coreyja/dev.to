class Internal::DogfoodController < Internal::ApplicationController
  ...
  def index
    ...
    @comment_totals_this_week = Comment.users_with_number_of_comments(user_ids, Time.zone.today.beginning_of_week)
    @comment_totals_24_hours = Comment.users_with_number_of_comments(user_ids, 24.hours.ago)
  end
end
