...
class DashboardManifest
  ...
  # to work correctly.
  DASHBOARDS = %i[articles users organizations comments follows reactions podcasts podcast_episodes collections tags email_messages feedback_messages display_ads badges badge_achievements html_variants].freeze
