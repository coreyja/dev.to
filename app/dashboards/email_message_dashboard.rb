...
class EmailMessageDashboard < Administrate::BaseDashboard
  ...
  COLLECTION_ATTRIBUTES = %i[user id subject opened_at clicked_at].freeze

  # SHOW_PAGE_ATTRIBUTES
  # an array of attributes that will be displayed on the model's show page.
  SHOW_PAGE_ATTRIBUTES = %i[user id token to mailer subject content utm_source utm_medium utm_term utm_content utm_campaign sent_at opened_at clicked_at].freeze
