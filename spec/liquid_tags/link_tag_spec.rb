...
RSpec.describe(LinkTag, type: :liquid_template) do
  ...
  let(:org_article) do
    create(:article, user_id: org_user.id, title: "test this please", tags: "tag1 tag2 tag3", organization_id: org.id)
  end
...
<div class='ltag__link'>
  ...
  it("raises an error when invalid") do
    expect { generate_new_liquid("fake_username/fake_article_slug") }.to(raise_error("Invalid link URL or link URL does not exist"))
  end
