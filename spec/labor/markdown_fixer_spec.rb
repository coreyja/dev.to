...
---
  ...
  describe("::fix_all") do
    it("escapes title and description") do
      result = described_class.fix_all(front_matter(title: sample_text, description: sample_text))
  ...
  describe("::fix_for_preview") do
    it("escapes title and description") do
      result = described_class.fix_for_preview(front_matter(title: sample_text, description: sample_text))
      expected_result = front_matter(title: "\"#{sample_text}\"", description: "\"#{sample_text}\"")
      expect(result).to(eq(expected_result))
    end
  end
