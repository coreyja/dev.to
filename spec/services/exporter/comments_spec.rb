...
RSpec.describe(Exporter::Comments) do
  ...
  def expected_fields
    %w[body_markdown created_at deleted edited edited_at id_code markdown_character_count positive_reactions_count processed_html receive_notifications commentable_path]
  end
