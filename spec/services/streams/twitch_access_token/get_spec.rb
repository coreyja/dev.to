...
RSpec.describe(Streams::TwitchAccessToken::Get, type: :service) do
  describe(".access_token") do
    ...
    let!(:twitch_token_stubbed_route) do
      stub_request(:post, "https://id.twitch.tv/oauth2/token").with(body: expected_twitch_token_body).and_return(body: {
        access_token: "FAKE_BRAND_NEW_TWITCH_TOKEN",
