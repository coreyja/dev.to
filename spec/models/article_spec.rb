...
RSpec.describe(Article, type: :model) do
  ...
  it("does not persist with invalid publish scoped data") do
    article = Article.create(title: "hey", body_html: "hey hey hey hey hey hey", published: true)
  ...
  describe("#body_text") do
    it("return a sanitized processed_html") do
      article.validate
      expect(article.body_text).to(eq(ActionView::Base.full_sanitizer.sanitize(article.processed_html)))
    end
  end
