...
ActiveRecord::Schema.define(version: 2019_05_04_131412) do
  ...
  create_table("ahoy_messages", id: :serial, force: :cascade) do |t|
    ...
    t.index([
      "user_id",
      "user_type",
    ], name: "index_ahoy_messages_on_user_id_and_user_type")
  end
  ...
  create_table("badge_achievements", force: :cascade) do |t|
    ...
    t.index([
      "user_id",
      "badge_id",
    ], name: "index_badge_achievements_on_user_id_and_badge_id")
  ...
  create_table("chat_channel_memberships", force: :cascade) do |t|
    ...
    t.index([
      "user_id",
      "chat_channel_id",
    ], name: "index_chat_channel_memberships_on_user_id_and_chat_channel_id")
  ...
  create_table("html_variant_successes", force: :cascade) do |t|
    ...
    t.index([
      "html_variant_id",
      "article_id",
    ], name: "index_html_variant_successes_on_html_variant_id_and_article_id")
  end
  ...
  create_table("html_variant_trials", force: :cascade) do |t|
    ...
    t.index([
      "html_variant_id",
      "article_id",
    ], name: "index_html_variant_trials_on_html_variant_id_and_article_id")
  end
  ...
  create_table("identities", id: :serial, force: :cascade) do |t|
    ...
    t.index([
      "provider",
      "uid",
    ], name: "index_identities_on_provider_and_uid", unique: true)
    t.index([
      "provider",
      "user_id",
    ], name: "index_identities_on_provider_and_user_id", unique: true)
  end
  ...
  create_table("mentor_relationships", force: :cascade) do |t|
    ...
    t.index([
      "mentee_id",
      "mentor_id",
    ], name: "index_mentor_relationships_on_mentee_id_and_mentor_id", unique: true)
  ...
  create_table("notifications", id: :serial, force: :cascade) do |t|
    ...
    t.index([
      ...
      "notifiable_type",
      "action",
    ], name: "index_notifications_on_user_organization_notifiable_and_action", unique: true)
  ...
  create_table("organization_memberships", force: :cascade) do |t|
    ...
    t.index([
      "user_id",
      "organization_id",
    ], name: "index_organization_memberships_on_user_id_and_organization_id", unique: true)
  end
