...
Rails.application.configure do
  ...
  # Timber.io logger
  send_logs_to_timber = ENV["SEND_LOGS_TO_TIMBER"] || "true"
  ...
  config.action_mailer.default_url_options = {
    host: ENV["APP_PROTOCOL"] + ENV["APP_DOMAIN"],
  }
  ...
  config.middleware.use(Rack::HostRedirect, "practicaldev.herokuapp.com" => "dev.to")
end
